...
def moreOptions():
    ...
    while True:
        ...
        {blue}[10] {lcyan}Discord Usernames Checker                                                 {blue}[18] {lcyan}Zip File {lcyan}Password Cracker
        {blue}[11] {lcyan}Discord Webhook Spammer                                                   {blue}[19] {lcyan}IP LOOKUP
        {blue}[12] {lcyan}Malware {green}(Steal Google Chrome And Opera GX Passwords)                      {blue}[20] {lcyan}Phone Number Tracker
        {blue}[13] {lcyan}Extract All WI-FI Passwords That You Have Connected Recently              {blue}[99] {lcyan}Main Menu      
        {blue}[14] {lcyan}Most Nmap Commands Used By {green}(Black Hat Team)
        {blue}[15] {lcyan}Wordlist Generator {green}(Brute Force And Dictionary Attack){rescolor}
        {blue}[16] {lcyan}Convert {green}Python {lcyan}File To {green}EXE {lcyan}File     
        {blue}[17] {lcyan}Hash {lcyan}Cracker

             ''')
                cmd = input(f'{lcyan}!{blue}]==={lcyan}卐卐卐卐卐卐卐卐卐卐卐卐卐{blue}==>{white} ')
        ...
        while True:
            ...
            print(fr'''{white}
                   ...
                   {yellow}                 \|{white}___________________________,.-'`           
                                ...
                                /------/                                        \
                               /                                                 \ 
                              {blue}|    {blue}[+] Name        : {lcyan}SABAH                       {blue}|
                              {blue}|    {blue}[+] Instagram   : {lcyan}Apkaless                    {blue}|
                              {blue}|    {blue}[+] Github      : {lcyan}https://github.com/apkaless {blue}|
                              {blue}|    {blue}[+] Codename    : {lcyan}卐                          {blue}|
                              {blue}|    {blue}[+] Nationality : {lcyan}Iraq                        {blue}|                
        ================================================================================================
                                
        {blue}[1] {lcyan}IDM Trial Reset                                 {blue}[8] {lcyan}PUBLIC IP
        {blue}[2] {lcyan}Activate Windows {green}(10 & 11)                      {blue}[9] {lcyan}SYSTEM INFORMATION
        {blue}[3] {lcyan}Optimize Network Adapter                        {blue}[99] {lcyan}More
        {blue}[4] {lcyan}Fix The Game's Server Refuse Your Connection
        {blue}[5] {lcyan}Proxy Generator
        {blue}[6] {lcyan}Proxy Checker
        {blue}[7] {lcyan}Clean Your System With One Hit                    

         ''')
    
            cmd = input(f'{blue}[{green}{str(datetime.now().strftime('%a:%m:%d:%y | %I:%M %p'))}{blue}]==={lcyan}卐卐卐卐卐卐卐卐卐卐卐卐卐{blue}==>{white} ')
