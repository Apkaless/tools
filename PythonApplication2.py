...
{green}[10] {lcyan}Discord Usernames Checker                                                 {green}[21] {lcyan}Zip File {lcyan}Password Cracker
{green}[11] {lcyan}Discord Webhook Spammer                                                   {green}[22] {lcyan}IP & Domain LOOKUP
{green}[12] {lcyan}Malware {green}(Steal Google Chrome And Opera GX Passwords)                      {green}[23] {lcyan}Phone Number Tracker
